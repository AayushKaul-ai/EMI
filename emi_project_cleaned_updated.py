# -*- coding: utf-8 -*-
"""EMI_Project_cleaned_updated.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1YkeXTTSgyDxl20xFZLdAmYdyxiPxwr9G
"""
...
path = "EMI_Project_cleaned_updated.ipynb" # Corrected filename to be case-sensitive
...
with open("EMI_Project_cleaned_updated_UTF8.ipynb", "w", encoding="utf-8") as f:
    json.dump(data, f, ensure_ascii=False)

print("Saved cleaned UTF-8 notebook as EMI_Project_cleaned_updated_UTF8.ipynb")
